...
export default function Home() {
  return (
    <>
      <Navbar />
      <div className="bg-white md:pt-52 xs:pt-20 min-h-screen dark:bg-gray-800">
        <div className="grid md:grid-cols-2 sm:grid-cols-1">
          ...
          <Image
            ...
            width={300}
            height={300}
            className="justify-self-center self-center rounded-2xl xs:py-16 md:p-0 drop-shadow-lg"
          />
        </div>
      </div>
      <Footer />
